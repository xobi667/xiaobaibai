...
test.describe('Visual Regression Tests', () => {
  ...
  test('ImagePreview component visual regression', async ({ page }) => {
    ...
    try {
      ...
      // Take screenshot of ImagePreview component
      const imagePreview = page.locator('.image-preview, [data-testid="image-preview"]').first()
      ...
      if (await imagePreview.count() > 0) {
        ...
        await expect(page).toHaveScreenshot('image-preview-page.png', {
          fullPage: true,
          maxDiffPixels: 200,
        })
      }
