...
class Settings(db.Model):
    ...
    seedream_api_key = db.Column(db.String(500), nullable=True)  # Seedream 生图专用 API Key（可选）
    ...
    def to_dict(self):
        ...
        return {
            ...
            'seedream_api_key_length': len(self.seedream_api_key) if self.seedream_api_key else 0,
    ...
    def get_settings():
        ...
        if not settings:
            ...
            settings = Settings(
                ...
                seedream_api_key=(getattr(Config, "SEEDREAM_API_KEY", "") or None),
